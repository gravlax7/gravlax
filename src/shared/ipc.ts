...
export interface IpcInvokeMap {
  ...
  'upload:previewBbcode': { args: [{ trackerId: UploadTrackerId; source: string }]; result: string }
...
export const IPC_ARGUMENT_SCHEMAS: {
  ...
  'upload:previewBbcode': z.tuple([z.object({ trackerId: trackerID, source: z.string() })]),
